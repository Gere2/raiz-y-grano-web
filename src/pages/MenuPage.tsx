...
const menuByLanguage: Record<'es' | 'en' | 'fr', MenuCategory[]> = {
  ...
  en: [
    ...
    },
    {
      ...
      icon: <Flower size={22} className="text-[#a18968]" />,
      items: [
        { name: 'Green Tea', price: '2,00 €', description: '' },
        { name: 'Ginger & Lemon', price: '2,00 €', description: '' },
        { name: 'Rooibos Tea (Hibiscus, Strawberry & Plums)', price: '2,00 €', description: '' },
      ],
    },
    {
      title: 'BOWLS & ENERGY',
    ...
    },
    {
      ...
      icon: <Cake size={22} className="text-[#a18968]" />,
      items: [
        { name: 'Classic cheesecake', price: '3,50 €', description: '' },
        { name: 'Pistachio cheesecake', price: '3,50 €', description: '' },
        { name: 'Carrot cake with walnuts', price: '2,50 €', description: '' },
        { name: 'Blueberry muffin', price: '1,50 €', description: '' },
        { name: 'Pumpkin muffin', price: '1,50 €', description: '' },
        { name: 'Chocolate chip cookie', price: '2,00 €', description: '' },
        { name: 'White chocolate & walnut cookies', price: '2,00 €', description: '' },
        { name: 'Dark chocolate & pistachio cookies', price: '2,00 €', description: '' },
      ],
    },
  ],
  fr: [
    ...
    },
    {
      ...
      icon: <Flower size={22} className="text-[#a18968]" />,
      items: [
        { name: 'Thé vert', price: '2,00 €', description: '' },
        { name: 'Gingembre et citron', price: '2,00 €', description: '' },
        { name: 'Thé rooibos (Hibiscus, fraise et prunes)', price: '2,00 €', description: '' },
      ],
    },
    {
      title: 'BOWLS & ÉNERGIE',
    ...
    },
    {
      ...
      icon: <Cake size={22} className="text-[#a18968]" />,
      items: [
        { name: 'Cheesecake classique', price: '3,50 €', description: '' },
        { name: 'Cheesecake à la pistache', price: '3,50 €', description: '' },
        { name: 'Gâteau à la carotte et noix', price: '2,50 €', description: '' },
        { name: 'Muffin aux myrtilles', price: '1,50 €', description: '' },
        { name: 'Muffin à la citrouille', price: '1,50 €', description: '' },
        { name: 'Cookie aux pépites de chocolat', price: '2,00 €', description: '' },
        { name: 'Cookies chocolat blanc et noix', price: '2,00 €', description: '' },
        { name: 'Cookies chocolat noir et pistache', price: '2,00 €', description: '' },
      ],
    },
  ],
};
