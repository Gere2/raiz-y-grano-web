...
const HomeSection = () => {
  ...
  return (
    <section id="home" className="min-h-screen flex flex-col justify-center items-center relative overflow-hidden">
      ...
      <div className="absolute inset-0 bg-raiz-beige -z-10 opacity-70">
      ...
      <div className="max-w-5xl mx-auto px-4 pt-28 md:pt-20 text-center">
        <div className={`mb-12 transition-all duration-1000 ease-out transform ${isAnimated ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
          {/* Foodtruck Hero Image with shadow and subtle animation */}
          <div className="relative mb-8 inline-block">
            <img 
              src="/lovable-uploads/40a04ff7-6485-45f6-b34e-1aa8eb905412.png" 
              alt="Raíz y Grano Foodtruck" 
              className="w-full max-w-2xl mx-auto drop-shadow-xl animate-float"
            />
            <div className="absolute -z-10 inset-0 bg-raiz-olive opacity-5 blur-xl rounded-full transform scale-90 translate-y-6"></div>
          </div>
